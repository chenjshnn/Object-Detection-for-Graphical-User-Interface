...
# set up rico
datasetss = ["rico", "ricotext", "ricoOriText", "rico2k", "rico10k",\
"ricodefaultAspectRatio", "ricobetterRatioAndScale", "ricoRight",\
"ricoFold0", "ricoFold1","ricoFold2","ricoFold3", "ricoCombined", "ricoBetter2"]
for which in datasetss:
  for split in ['train', 'val', 'test']:
      name = '{}_{}'.format(which, split)
      __sets[name] = (lambda split=split: rico(split, which))
