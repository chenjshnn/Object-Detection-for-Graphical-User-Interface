...
class UI5K(DETECTION):
    def __init__(self, db_config, split):
        super(UI5K, self).__init__(db_config)
        ...
        self._dataset_dirname = {
            "trainval": "/media/cheer/NewVolume/5K_data",
            "minival": "/media/cheer/NewVolume/5K_data",
            "testdev": "/media/cheer/NewVolume/5K_data"
        }[self._split]
        
        self._coco_dir = data_dir #os.path.join(data_dir, "coco")
        print(self._coco_dir)

        self._label_dir  = os.path.join(self._coco_dir, "annotations")
        self._label_file = os.path.join(self._label_dir, "ui5k_10000.json")
        ...
        self._cache_file = os.path.join(cache_dir, "ui5k_{}.pkl".format(self._dataset))
        self._load_data()
