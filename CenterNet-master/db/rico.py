...
class RICO(DETECTION):
    def __init__(self, db_config, split):
        super(RICO, self).__init__(db_config)
        ...
        self._label_file = self._label_file.format(self._split)
    ...
    def evaluate(self, result_json, cls_ids, image_ids, gt_json=None):
        ...
        cat_ids  = cls_ids #[self._classes[cls_id] for cls_id in cls_ids]
