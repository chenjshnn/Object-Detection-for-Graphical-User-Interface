...
if __name__ == "__main__":
    ...
    system_configs.update_config({"categories":configs["db"]["categories"], "current_split":args.split})
    ...
    test(testing_db, args.split, args.testiter, configs["db"]["categories"], args.debug, args.suffix)
